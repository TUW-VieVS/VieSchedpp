...
class Eci {
   public:
     ...
     */
    Eci( const DateTime& dt, const CoordGeodetic& geo ) { ToEci( dt, geo ); }
     ...
     */
    bool operator==( const DateTime& dt ) const { return m_dt == dt; }
     ...
     */
    void Update( const DateTime& dt, const CoordGeodetic& geo ) { ToEci( dt, geo ); }
     ...
     * @returns the date
     */
    DateTime GetDateTime() const { return m_dt; }
