...
namespace VieVS{
    ...
    protected:
         ...
         * @author Matthias Schartner
         *
         * checks if value ax1 is inside the allowed first axis range and if value ax2 is inside the allowed second axis range.
         * basically checks if target at postion (ax1, ax2) can be observed.
         *
