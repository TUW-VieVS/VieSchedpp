...
/**
 * @file CableWrap_HaDc.h
 * @brief class hour angle, declination cable wrap
 *
 ...
 * @brief hour angle, declination cable wrap
 *
 * @author Matthias Schartner
 * @date 12.04.2018
 */
class CableWrap_HaDc : public AbstractCableWrap {
   public:
    /**
     * @brief constructor
     * @author Matthias Schartner
     *
     * @param axis1_low_deg hour angle lower limit in degrees
     * @param axis1_up_deg hour angle upper limit in degrees
     * @param axis2_low_deg declination lower limit in degrees
     * @param axis2_up_deg declination upper limit in degrees
     */
     ...
     * @author Matthias Schartner
     *
     * @return antenna motion name for first and second axis (e.g.: {"ha", "dec"})
     */
