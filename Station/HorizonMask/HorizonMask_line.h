...
/**
 * @file HorizonMask_line.h
 * @brief class HorizonMask_line
 *
...
class HorizonMask_line : public AbstractHorizonMask {
   public:
     ...
     * @author Matthias Schartner
     *
     * @param azimuths horizon mask edge azimuths
     * @param elevations horizon mask edge elevations
     */
