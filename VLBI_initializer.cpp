...
namespace VieVS{
    ...
    VLBI_initializer::readCatalog(const string &root, const string &fname, catalog type, ofstream &headerLog) noexcept {
    ...
    void VLBI_initializer::createStations(ofstream &headerLog) noexcept {
        std::string root = PARA_xml.get<string>("master.catalogs.root");
        std::string antenna = PARA_xml.get<string>("master.catalogs.antenna");
        std::string position = PARA_xml.get<string>("master.catalogs.position");
        std::string equip = PARA_xml.get<string>("master.catalogs.equip");
        std::string mask = PARA_xml.get<string>("master.catalogs.mask");
    ...
    void VLBI_initializer::createSources(ofstream &headerLog) noexcept {
        std::string root = PARA_xml.get<string>("master.catalogs.root");
        std::string source = PARA_xml.get<string>("master.catalogs.source");
        std::string flux = PARA_xml.get<string>("master.catalogs.flux");
