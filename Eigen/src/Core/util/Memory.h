...
#define EIGEN_FREEBSD_MALLOC_ALREADY_ALIGNED 0
    ...
    ( EIGEN_OS_WIN64 && ( EIGEN_DEFAULT_ALIGN_BYTES == 16 ) ) || EIGEN_GLIBC_MALLOC_ALREADY_ALIGNED || \
...
#define EIGEN_ALIGNED_ALLOCA( SIZE )                                                                       \
    reinterpret_cast<void*>( ( internal::UIntPtr( EIGEN_ALLOCA( SIZE + EIGEN_DEFAULT_ALIGN_BYTES - 1 ) ) + \
...
class aligned_allocator : public std::allocator<T> {
   public:
    ...
    pointer allocate( size_type num, const void* /*hint*/ = 0 ) {
        ...
        // It triggered eigen/Eigen/src/Core/util/Memory.h:189:12: warning: argument 1 value '18446744073709551612'
