    ...
    enum {
        ...
        InnerMaxSize =
            int( Dst::IsVectorAtCompileTime )
                ...
                : int( DstFlags ) & RowMajorBit ? int( Dst::MaxColsAtCompileTime ) : int( Dst::MaxRowsAtCompileTime ),
    ...
    enum {
        ...
        MayUnrollCompletely = int( Dst::SizeAtCompileTime ) != Dynamic &&
                              int( Dst::SizeAtCompileTime ) *
                                  ...
                                  int( UnrollingLimit ),
        MayUnrollInner = int( InnerSize ) != Dynamic && int( InnerSize ) * ( int( DstEvaluator::CoeffReadCost ) +
